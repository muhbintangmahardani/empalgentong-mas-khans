      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div key={activeFilter} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 animate-fade-in">
          {filteredMenu.map((item) => (
            ...
            >
              {/* PERBAIKAN: Menambahkan bg-neutral-50 agar menyatu, dan p-2 agar ada ruang bernapas */}
              <div className="h-48 md:h-52 w-full rounded-2xl overflow-hidden mb-4 relative bg-neutral-50 p-2 flex items-center justify-center">
                
                {/* PERBAIKAN UTAMA: object-contain memastikan 100% gambar terlihat tanpa terpotong atas bawah */}
                <img 
                  src={item.image} 
                  alt={item.name} 
                  className="w-full h-full object-contain transform scale-100 group-hover:scale-110 transition-transform duration-500" 
                />
                
                <div className="absolute inset-0 bg-gradient-to-t from-neutral-900/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"></div>
              ...
              <div className="flex items-center justify-between px-2 pt-4 border-t border-neutral-100 mt-auto">
                ...
                <div className="relative z-20">
                  <div className="absolute inset-0 bg-amber-400 rounded-2xl opacity-0 group-hover:opacity-100 group-hover:animate-ping pointer-events-none"></div>
                  <button 
      ...
      {selectedItem && (
        ...
        >
          ...
          >
            ...
            <div className="relative h-56 md:h-64 w-full bg-neutral-50 p-4 flex items-center justify-center">
              {/* PERBAIKAN MODAL: object-contain agar modal juga menampilkan gambar secara utuh */}
              <img 
